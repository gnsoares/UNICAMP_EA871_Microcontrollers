...
#define FGPIO_BASE_PTRS \
    { FPTA_BASE_PTR, FPTB_BASE_PTR, FPTC_BASE_PTR, FPTD_BASE_PTR, FPTE_BASE_PTR }
...
#define TPM_BASE_PTRS \
    { TPM0_BASE_PTR, TPM1_BASE_PTR, TPM2_BASE_PTR }
